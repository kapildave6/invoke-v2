...
public final class PaletteView: NSView {
    ...
    private func reconcileFormInPlace(_ form: ViewNode) -> Bool {
        let fieldTypes: Set<String> = ["form-textfield", "form-textarea", "form-checkbox", "form-dropdown", "form-description", "form-separator", "form-password", "form-datepicker", "window-grid-picker"]
        var fields: [ViewNode] = []
