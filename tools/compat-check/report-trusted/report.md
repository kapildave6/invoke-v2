...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; getSelectedFinderItems: throws — Finder selection not wired; launchCommand: launchCommand not implemented
- Degraded: uses Node built-ins (ok in trusted mode): fs, child_process

### `agent-usage` — Agent Usage
- dir: `agent-usage` · commands: 2 · modes: view|menu-bar
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): agent-usage-menubar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, module, child_process, http, https
- Needs review: @raycast/utils:getProgressIcon (not implemented in Invoke)
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; AI: AI.ask throws — Invoke AI not yet wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; getFrontmostApplication: throws — application discovery not wired
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process, http
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/api:clearSearchBar (not in Invoke surface — needs review)

### `app-updates` — App Updates
- dir: `app-updates` · commands: 4 · modes: view|menu-bar
- **Blockers:** launchCommand: launchCommand not implemented; AI: AI.ask throws — Invoke AI not yet wired; unsupported command mode(s): menu-bar: mode "menu-bar", brew-maintenance: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs

### `appcleaner` — App Cleaner
- dir: `appcleaner` · commands: 1 · modes: view
- **Blockers:** getApplications: throws — application discovery not wired; updateCommandMetadata: menu-bar/command metadata updates not implemented
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** trash: throws — file trash not wired
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, module, fs
...
- **Blockers:** launchCommand: launchCommand not implemented; AI: AI.ask throws — Invoke AI not yet wired; unsupported command mode(s): menu-bar: mode "menu-bar"; declares AI tools[] (8) — AI extensions not supported
...
- **Blockers:** getApplications: throws — application discovery not wired; showInFinder: throws — showInFinder not wired; launchCommand: launchCommand not implemented; getSelectedText: throws — selection APIs not wired; unsupported command mode(s): menu-bar: mode "menu-bar"; declares AI tools[] (12) — AI extensions not supported
- Degraded: openCommandPreferences: no-op; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; showInFinder: throws — showInFinder not wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, child_process

### `asset-catalog-extractor` — Asset Catalog Extractor
- dir: `asset-catalog-extractor` · commands: 1 · modes: no-view
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; getApplications: throws — application discovery not wired
- Degraded: uses Node built-ins (ok in trusted mode): child_process, fs

### `at-profile` — @ Profile
- dir: `at-profile` · commands: 6 · modes: view|no-view
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; declares AI tools[] (2) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: openCommandPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, https
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; captureException: no-op; confirmAlert: always returns false (no dialog); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; trash: throws — file trash not wired
- Degraded: uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: openCommandPreferences: no-op; openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process

### `bartender` — Bartender
- dir: `bartender` · commands: 4 · modes: no-view|view
- **Blockers:** declares AI tools[] (4) — AI extensions not supported
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openCommandPreferences: no-op; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar: mode "menu-bar"; declares AI tools[] (2) — AI extensions not supported
- Degraded: openCommandPreferences: no-op; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; declares AI tools[] (6) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getApplications: throws — application discovery not wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; showInFinder: throws — showInFinder not wired; getFrontmostApplication: throws — application discovery not wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; captureException: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process, http, https
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke); @raycast/utils:getFavicon (not implemented in Invoke)
...
- **Blockers:** trash: throws — file trash not wired; getSelectedText: throws — selection APIs not wired
- Degraded: openCommandPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, fs

### `bundles` — Bundles
- dir: `bundles` · commands: 1 · modes: view
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** declares AI tools[] (4) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): https
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; unsupported command mode(s): menubar-ccusage: mode "menu-bar"; declares AI tools[] (5) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; openCommandPreferences: no-op; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs, http

### `cerebras` — Cerebras
- dir: `cerebras` · commands: 8 · modes: view
- **Blockers:** getSelectedText: throws — selection APIs not wired; getFrontmostApplication: throws — application discovery not wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): http, fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; getFrontmostApplication: throws — application discovery not wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): http, fs, child_process
- Needs review: @raycast/api:clearSearchBar (not in Invoke surface — needs review); @raycast/api:BrowserExtension (not in Invoke surface — needs review); @raycast/api:Navigation (not in Invoke surface — needs review)
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; getFrontmostApplication: throws — application discovery not wired; trash: throws — file trash not wired; launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar-monitor: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, child_process, readline
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process

### `cling` — Cling File Search
- dir: `cling` · commands: 2 · modes: view
- **Blockers:** getFrontmostApplication: throws — application discovery not wired
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** launchCommand: launchCommand not implemented
- Degraded: confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: openCommandPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process

### `code-saver` — Code Saver
- dir: `code-saver` · commands: 2 · modes: view
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, https
- Needs review: @raycast/utils:getAvatarIcon (not implemented in Invoke)
...
- **Blockers:** showInFinder: throws — showInFinder not wired; launchCommand: launchCommand not implemented; trash: throws — file trash not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process

### `coffee` — Coffee
- dir: `coffee` · commands: 9 · modes: no-view|view|menu-bar
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; launchCommand: launchCommand not implemented; unsupported command mode(s): index: mode "menu-bar"; declares AI tools[] (6) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; launchCommand: launchCommand not implemented
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
- Needs review: namespace import of @raycast/api (member usage unverified)
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; showInFinder: throws — showInFinder not wired
- Degraded: confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** declares AI tools[] (1) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar: mode "menu-bar"; declares AI tools[] (3) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs

### `custom-icon` — Custom Icon
- dir: `custom-icon` · commands: 2 · modes: view
- **Blockers:** trash: throws — file trash not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): child_process, fs

### `cut-out` — Cut Out
- dir: `cut-out` · commands: 2 · modes: no-view
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; showInFinder: throws — showInFinder not wired
- Degraded: captureException: no-op; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; declares AI tools[] (7) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** launchCommand: launchCommand not implemented; getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; trash: throws — file trash not wired
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs

### `dev-servers` — Dev Servers
- dir: `dev-servers` · commands: 2 · modes: view
- **Blockers:** launchCommand: launchCommand not implemented; getFrontmostApplication: throws — application discovery not wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:clearSearchBar (not in Invoke surface — needs review)

### `digger` — Digger
- dir: `digger` · commands: 1 · modes: view
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): dns, tls
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process, readline
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; launchCommand: launchCommand not implemented; unsupported command mode(s): statusmenu: mode "menu-bar"
- Degraded: uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** trash: throws — file trash not wired; showInFinder: throws — showInFinder not wired; declares AI tools[] (6) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- Degraded: openCommandPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): https, fs
...
- **Blockers:** declares AI tools[] (3) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** trash: throws — file trash not wired
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** launchCommand: launchCommand not implemented
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:BrowserExtension (not in Invoke surface — needs review)

### `expand-video-canvas` — Expand Video Canvas
- dir: `expand-video-canvas` · commands: 1 · modes: no-view
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): child_process, fs, dgram

### `fathom` — Fathom
- dir: `fathom` · commands: 2 · modes: view
- **Blockers:** launchCommand: launchCommand not implemented; declares AI tools[] (3) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; declares AI tools[] (3) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process

### `fifteen-million-merits` — Fifteen Million Merits
- dir: `fifteen-million-merits` · commands: 2 · modes: menu-bar|no-view
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): show-ai-agent-sessions-counter: mode "menu-bar"
- Degraded: declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:useFrecencySorting (not implemented in Invoke)
...
- **Blockers:** trash: throws — file trash not wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** declares AI tools[] (5) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** declares AI tools[] (10) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): exercise-reminder: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process

### `fix-helper` — FIX Helper
- dir: `fix-helper` · commands: 2 · modes: view
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): https, fs
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: captureException: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)

### `folder-organizer` — Folder Organizer
- dir: `folder-organizer` · commands: 3 · modes: no-view|view
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs

### `folder-search` — Folder Search
- dir: `folder-search` · commands: 2 · modes: view
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; trash: throws — file trash not wired
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)
...
- **Blockers:** getApplications: throws — application discovery not wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): fs

### `forked-extensions` — Forked Extensions
- dir: `forked-extensions` · commands: 1 · modes: view
- **Blockers:** launchCommand: launchCommand not implemented
- Degraded: confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: openExtensionPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process

### `gemini-cli` — Gemini CLI
- dir: `gemini-cli` · commands: 1 · modes: view
- **Blockers:** trash: throws — file trash not wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, readline

### `gemini-tts` — Gemini TTS
- dir: `gemini-tts` · commands: 9 · modes: no-view|view|menu-bar
- **Blockers:** launchCommand: launchCommand not implemented; getSelectedText: throws — selection APIs not wired; unsupported command mode(s): playback-status: mode "menu-bar"
- Degraded: openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): http, https
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)

### `get-app-icon` — Get App Icon
- dir: `get-app-icon` · commands: 1 · modes: view
- **Blockers:** getApplications: throws — application discovery not wired; showInFinder: throws — showInFinder not wired
- Degraded: uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; declares AI tools[] (14) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; getFrontmostApplication: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; getApplications: throws — application discovery not wired; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)

### `git-buddy` — Git Buddy
- dir: `git-buddy` · commands: 3 · modes: view
- **Blockers:** launchCommand: launchCommand not implemented; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): child_process, fs

### `github` — GitHub
- dir: `github` · commands: 20 · modes: view|menu-bar
- **Blockers:** showInFinder: throws — showInFinder not wired; launchCommand: launchCommand not implemented; unsupported command mode(s): unread-notifications: mode "menu-bar", my-issues-menu: mode "menu-bar", my-stats-menu: mode "menu-bar", my-pull-requests-menu: mode "menu-bar"; declares AI tools[] (15) — AI extensions not supported
...
- **Blockers:** launchCommand: launchCommand not implemented; OAuth: OAuth.PKCEClient throws — OAuth not yet wired; unsupported command mode(s): todomenubar: mode "menu-bar", mrmenu: mode "menu-bar", issuemenu: mode "menu-bar"; declares AI tools[] (12) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): https, fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; showInFinder: throws — showInFinder not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** launchCommand: launchCommand not implemented; OAuth: OAuth.PKCEClient throws — OAuth not yet wired; unsupported command mode(s): unreadmailsmenu: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; confirmAlert: always returns false (no dialog); declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:getAvatarIcon (not implemented in Invoke)
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): starred-google-drive-files-menubar: mode "menu-bar"; declares AI tools[] (2) — AI extensions not supported
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:clearSearchBar (not in Invoke surface — needs review)
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- **Blockers:** getApplications: throws — application discovery not wired; launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: captureException: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:useStreamJSON (not implemented in Invoke)
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, net
...
- **Blockers:** showInFinder: throws — showInFinder not wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: openCommandPreferences: no-op; confirmAlert: always returns false (no dialog); captureException: no-op; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): notificationmenu: mode "menu-bar", weathermenu: mode "menu-bar", mediaplayermenu: mode "menu-bar", lightsmenu: mode "menu-bar", coversmenu: mode "menu-bar", batteriesmenu: mode "menu-bar", entitiesmenu: mode "menu-bar", entitymenu01: mode "menu-bar", entitymenu02: mode "menu-bar", entitymenu03: mode "menu-bar", calendarmenu: mode "menu-bar"; declares AI tools[] (3) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, https, child_process
- Needs review: @raycast/api:clearSearchBar (not in Invoke surface — needs review)
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): tls, https, net, fs, http2, dns
- Needs review: @raycast/utils:getProgressIcon (not implemented in Invoke)

### `hugeicons-ui` — Hugeicons UI
- dir: `hugeicons-ui` · commands: 4 · modes: view
- **Blockers:** declares AI tools[] (3) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: openCommandPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:MutatePromise (not implemented in Invoke)
...
- **Blockers:** showInFinder: throws — showInFinder not wired; unsupported command mode(s): switch: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, child_process, https

### `ilovepdf` — iLovePDF
- dir: `ilovepdf` · commands: 16 · modes: view
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:runPowerShellScript (not implemented in Invoke)
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:MutatePromise (not implemented in Invoke)
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; launchCommand: launchCommand not implemented; unsupported command mode(s): menubar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:getProgressIcon (not implemented in Invoke)

### `internet-radio` — Internet Radio
- dir: `internet-radio` · commands: 11 · modes: view|no-view|menu-bar
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; launchCommand: launchCommand not implemented; unsupported command mode(s): menubar-radio: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented
- Degraded: openCommandPreferences: no-op; openExtensionPreferences: no-op; captureException: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): net
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; declares AI tools[] (2) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)

### `itranslate` — iTranslate
- dir: `itranslate` · commands: 4 · modes: view
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; openCommandPreferences: no-op; openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, fs

### `ivpn` — IVPN
- dir: `ivpn` · commands: 12 · modes: no-view|view
- **Blockers:** launchCommand: launchCommand not implemented; getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); captureException: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getApplications: throws — application discovery not wired; unsupported command mode(s): recentMenu: mode "menu-bar"
- Degraded: captureException: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:useFrecencySorting (not implemented in Invoke)
...
- **Blockers:** showInFinder: throws — showInFinder not wired; launchCommand: launchCommand not implemented; declares AI tools[] (11) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; launchCommand: launchCommand not implemented; declares AI tools[] (10) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** launchCommand: launchCommand not implemented; AI: AI.ask throws — Invoke AI not yet wired; declares AI tools[] (1) — AI extensions not supported
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; launchCommand: launchCommand not implemented; showInFinder: throws — showInFinder not wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): fs

### `jump` — Jump
- dir: `jump` · commands: 4 · modes: no-view|view
- **Blockers:** launchCommand: launchCommand not implemented
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menubar-keyboard-brightness: mode "menu-bar"
- Degraded: uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** declares AI tools[] (3) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getApplications: throws — application discovery not wired; declares AI tools[] (7) — AI extensions not supported
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; updateCommandMetadata: menu-bar/command metadata updates not implemented; trash: throws — file trash not wired; unsupported command mode(s): check-deploy-status: mode "menu-bar"
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): https
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menubar-move: mode "menu-bar"; declares AI tools[] (3) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process

### `linak-desk-controller` — Linak Desk Controller
- dir: `linak-desk-controller` · commands: 4 · modes: no-view|menu-bar
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menubar-move: mode "menu-bar"
- Degraded: openExtensionPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process

### `linear` — Linear
- dir: `linear` · commands: 14 · modes: view|menu-bar|no-view
- **Blockers:** getApplications: throws — application discovery not wired; launchCommand: launchCommand not implemented; unsupported command mode(s): unread-notifications: mode "menu-bar"; declares AI tools[] (22) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, dgram, http
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; declares AI tools[] (5) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** showInFinder: throws — showInFinder not wired; declares AI tools[] (6) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** launchCommand: launchCommand not implemented
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** trash: throws — file trash not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; launchCommand: launchCommand not implemented; getDefaultApplication: throws — application discovery not wired; showInFinder: throws — showInFinder not wired
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:useAI (not implemented in Invoke)
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; showInFinder: throws — showInFinder not wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- **Blockers:** launchCommand: launchCommand not implemented; OAuth: OAuth.PKCEClient throws — OAuth not yet wired; unsupported command mode(s): menu-bar-notifications: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; getSelectedFinderItems: throws — Finder selection not wired; launchCommand: launchCommand not implemented; declares AI tools[] (2) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openCommandPreferences: no-op; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process, module
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- Degraded: confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; declares AI tools[] (1) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, http, https
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): http
...
- **Blockers:** trash: throws — file trash not wired; launchCommand: launchCommand not implemented; unsupported command mode(s): health-menu-bar: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** launchCommand: launchCommand not implemented
- Degraded: declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): net, child_process
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:useFrecencySorting (not implemented in Invoke)
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; unsupported command mode(s): currently-playing-menu-bar: mode "menu-bar"; declares AI tools[] (21) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openCommandPreferences: no-op; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): mute-menu-bar: mode "menu-bar"
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; openCommandPreferences: no-op; openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: openCommandPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:MutatePromise (not implemented in Invoke)
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)
...
- **Blockers:** getDefaultApplication: throws — application discovery not wired; declares AI tools[] (7) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke); @raycast/utils:getAvatarIcon (not implemented in Invoke)
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar-command: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** launchCommand: launchCommand not implemented; getSelectedText: throws — selection APIs not wired; unsupported command mode(s): nuxt-dev-server: mode "menu-bar"; declares AI tools[] (8) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; getDefaultApplication: throws — application discovery not wired; unsupported command mode(s): obsidianMenuBar: mode "menu-bar"; declares AI tools[] (7) — AI extensions not supported
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)

### `obsidian-bookmarks` — Obsidian Bookmarks
- dir: `obsidian-bookmarks` · commands: 3 · modes: view|no-view
- **Blockers:** trash: throws — file trash not wired; getApplications: throws — application discovery not wired
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getApplications: throws — application discovery not wired; getDefaultApplication: throws — application discovery not wired; getSelectedText: throws — selection APIs not wired; getFrontmostApplication: throws — application discovery not wired; unsupported command mode(s): open-link-from-menubar: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): net
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; updateCommandMetadata: menu-bar/command metadata updates not implemented; getSelectedText: throws — selection APIs not wired; showInFinder: throws — showInFinder not wired
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; launchCommand: launchCommand not implemented; updateCommandMetadata: menu-bar/command metadata updates not implemented; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** declares AI tools[] (7) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openCommandPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); captureException: no-op; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)
...
- **Blockers:** declares AI tools[] (2) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: captureException: no-op; openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; getSelectedFinderItems: throws — Finder selection not wired; declares AI tools[] (3) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)

### `pieces-raycast` — Pieces for Raycast
- dir: `pieces-raycast` · commands: 9 · modes: no-view|view
- **Blockers:** launchCommand: launchCommand not implemented; getSelectedFinderItems: throws — Finder selection not wired; getSelectedText: throws — selection APIs not wired
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; getApplications: throws — application discovery not wired; getSelectedText: throws — selection APIs not wired; getFrontmostApplication: throws — application discovery not wired; AI: AI.ask throws — Invoke AI not yet wired; unsupported command mode(s): index: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, vm, child_process
- Needs review: @raycast/utils:getFavicon (not implemented in Invoke)
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; AI: AI.ask throws — Invoke AI not yet wired; getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): pomodoro-menu-bar: mode "menu-bar", slack-pomodoro-menu-bar: mode "menu-bar"; declares AI tools[] (4) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:OAuthService (not implemented in Invoke); @raycast/utils:getAccessToken (not implemented in Invoke); @raycast/utils:withAccessToken (not implemented in Invoke)
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; declares AI tools[] (6) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs

### `positron` — Positron
- dir: `positron` · commands: 3 · modes: view|no-view
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): lowpower-menubar: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** declares AI tools[] (1) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; AI: AI.ask throws — Invoke AI not yet wired; launchCommand: launchCommand not implemented; getSelectedText: throws — selection APIs not wired; unsupported command mode(s): menubar-item: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:useAI (not implemented in Invoke)
...
- **Blockers:** launchCommand: launchCommand not implemented; trash: throws — file trash not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; showInFinder: throws — showInFinder not wired; getFrontmostApplication: throws — application discovery not wired; getSelectedFinderItems: throws — Finder selection not wired; unsupported command mode(s): search-pins-menu-bar: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:MutatePromise (not implemented in Invoke)
...
- **Blockers:** getDefaultApplication: throws — application discovery not wired; launchCommand: launchCommand not implemented
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; trash: throws — file trash not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** trash: throws — file trash not wired; declares AI tools[] (9) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; launchCommand: launchCommand not implemented
- Degraded: confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** launchCommand: launchCommand not implemented; getSelectedText: throws — selection APIs not wired; getSelectedFinderItems: throws — Finder selection not wired; declares AI tools[] (2) — AI extensions not supported
- Degraded: declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar-task: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; AI: AI.ask throws — Invoke AI not yet wired; getSelectedText: throws — selection APIs not wired
- Degraded: declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process, https
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getApplications: throws — application discovery not wired
- Degraded: captureException: no-op; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menu: mode "menu-bar"
- Degraded: openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): favourite-game-players: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:getAvatarIcon (not implemented in Invoke)
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; declares AI tools[] (23) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getApplications: throws — application discovery not wired; launchCommand: launchCommand not implemented; showInFinder: throws — showInFinder not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): net, tls, fs, child_process
- Needs review: @raycast/api:BrowserExtension (not in Invoke surface — needs review)
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getDefaultApplication: throws — application discovery not wired; trash: throws — file trash not wired
- Degraded: openCommandPreferences: no-op; openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); captureException: no-op; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:useAI (not implemented in Invoke)

### `simple-reminder` — Simple Reminder
- dir: `simple-reminder` · commands: 3 · modes: view|no-view|menu-bar
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; launchCommand: launchCommand not implemented; unsupported command mode(s): reminderMenuBar: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); captureException: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired; getFrontmostApplication: throws — application discovery not wired; declares AI tools[] (11) — AI extensions not supported
- Degraded: openCommandPreferences: no-op; openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process, https
...
- **Blockers:** declares AI tools[] (5) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:MutatePromise (not implemented in Invoke)
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): timersMenuBar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar-player: mode "menu-bar"
- Degraded: declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; launchCommand: launchCommand not implemented; OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): http
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; launchCommand: launchCommand not implemented; trash: throws — file trash not wired; showInFinder: throws — showInFinder not wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process

### `spiceblow-database` — Spiceblow - Sql Database Management
- dir: `spiceblow-database` · commands: 1 · modes: view
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; getSelectedText: throws — selection APIs not wired; launchCommand: launchCommand not implemented
- Degraded: declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, https

### `steam` — Steam
- dir: `steam` · commands: 1 · modes: view
- **Blockers:** trash: throws — file trash not wired; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:useAI (not implemented in Invoke)
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; getFrontmostApplication: throws — application discovery not wired; launchCommand: launchCommand not implemented; unsupported command mode(s): menubar-stickies: mode "menu-bar"
- Degraded: captureException: no-op; openCommandPreferences: no-op; openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:MutatePromise (not implemented in Invoke)
...
- **Blockers:** declares AI tools[] (2) — AI extensions not supported
- Degraded: openCommandPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getDefaultApplication: throws — application discovery not wired; getFrontmostApplication: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; launchCommand: launchCommand not implemented; getSelectedFinderItems: throws — Finder selection not wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)
...
- Degraded: openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:getAvatarIcon (not implemented in Invoke)

### `tablepro` — TablePro
- dir: `tablepro` · commands: 9 · modes: view|no-view|menu-bar
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar-connections: mode "menu-bar"; declares AI tools[] (12) — AI extensions not supported
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; launchCommand: launchCommand not implemented; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs

### `tailscale` — Tailscale
- dir: `tailscale` · commands: 11 · modes: view|no-view|menu-bar
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; unsupported command mode(s): menubar: mode "menu-bar"
- Degraded: openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired; OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:OAuthService (not implemented in Invoke); @raycast/utils:withAccessToken (not implemented in Invoke)
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; launchCommand: launchCommand not implemented; unsupported command mode(s): show-today-in-menu-bar: mode "menu-bar"; declares AI tools[] (12) — AI extensions not supported
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menubar: mode "menu-bar"
- Degraded: openExtensionPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs, http
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; launchCommand: launchCommand not implemented; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, http, child_process
...
- **Blockers:** trash: throws — file trash not wired; declares AI tools[] (1) — AI extensions not supported
- Degraded: uses Node built-ins (ok in trusted mode): child_process, fs

### `tim` — Tim
- dir: `tim` · commands: 7 · modes: no-view|view
- **Blockers:** showInFinder: throws — showInFinder not wired; getSelectedFinderItems: throws — Finder selection not wired; getApplications: throws — application discovery not wired
- Degraded: captureException: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired; launchCommand: launchCommand not implemented
- Degraded: openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): timersMenuBar: mode "menu-bar", stopwatchMenuBar: mode "menu-bar"; declares AI tools[] (2) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getApplications: throws — application discovery not wired; launchCommand: launchCommand not implemented
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menu_bar: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:clearSearchBar (not in Invoke surface — needs review); @raycast/utils:getFavicon (not implemented in Invoke)

### `todoist` — Todoist
- dir: `todoist` · commands: 11 · modes: view|no-view|menu-bar
- **Blockers:** launchCommand: launchCommand not implemented; OAuth: OAuth.PKCEClient throws — OAuth not yet wired; getApplications: throws — application discovery not wired; unsupported command mode(s): menu-bar: mode "menu-bar"; declares AI tools[] (29) — AI extensions not supported
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): menuBar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, net
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired
- Degraded: openCommandPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; declares AI tools[] (3) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): https, child_process, fs
- Needs review: @raycast/api:clearSearchBar (not in Invoke surface — needs review)
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): http
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; launchCommand: launchCommand not implemented; unsupported command mode(s): live: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:useFrecencySorting (not implemented in Invoke)
...
- Degraded: openCommandPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): https
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): http, fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; getSelectedFinderItems: throws — Finder selection not wired; getFrontmostApplication: throws — application discovery not wired
- Degraded: uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:getProgressIcon (not implemented in Invoke)
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getSelectedFinderItems: throws — Finder selection not wired; getSelectedText: throws — selection APIs not wired; getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/api:BrowserExtension (not in Invoke surface — needs review)
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getSelectedFinderItems: throws — Finder selection not wired; getApplications: throws — application discovery not wired
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:runPowerShellScript (not implemented in Invoke)
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getApplications: throws — application discovery not wired; declares AI tools[] (3) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** launchCommand: launchCommand not implemented; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, fs, https
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): wi-fi-signal: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, dgram, net
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)

### `woocommerce-quicker` — WooCommerce Quicker
- dir: `woocommerce-quicker` · commands: 4 · modes: view
- **Blockers:** launchCommand: launchCommand not implemented
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): https
- Needs review: @raycast/utils:useLocalStorage (not implemented in Invoke)
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; unsupported command mode(s): menubar-totals: mode "menu-bar"; declares AI tools[] (6) — AI extensions not supported
- Degraded: openCommandPreferences: no-op; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** launchCommand: launchCommand not implemented; unsupported command mode(s): query-world-time-menu-bar: mode "menu-bar"
- Degraded: openCommandPreferences: no-op; openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): net
- Needs review: @raycast/utils:MutatePromise (not implemented in Invoke); @raycast/utils:getAvatarIcon (not implemented in Invoke)
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; launchCommand: launchCommand not implemented; getApplications: throws — application discovery not wired; unsupported command mode(s): show-recent-projects-in-menu-bar.command: mode "menu-bar", show-recent-builds-in-menu-bar.command: mode "menu-bar"; declares AI tools[] (14) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; getFrontmostApplication: throws — application discovery not wired; showInFinder: throws — showInFinder not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; unsupported command mode(s): menu-bar-projects: mode "menu-bar", menu-bar-deployment: mode "menu-bar"
- Degraded: confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs

### `zed-recent-projects` — Zed
- dir: `zed-recent-projects` · commands: 3 · modes: no-view|view
- **Blockers:** getApplications: throws — application discovery not wired; getSelectedFinderItems: throws — Finder selection not wired
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:runPowerShellScript (not implemented in Invoke)
...
- **Blockers:** updateCommandMetadata: menu-bar/command metadata updates not implemented; declares AI tools[] (2) — AI extensions not supported
- Degraded: openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired; getApplications: throws — application discovery not wired; declares AI tools[] (3) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, https, http, child_process

### `zipline` — Zipline
- dir: `zipline` · commands: 4 · modes: view|no-view
- **Blockers:** getSelectedFinderItems: throws — Finder selection not wired
- Degraded: confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** declares AI tools[] (3) — AI extensions not supported
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openCommandPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; confirmAlert: always returns false (no dialog); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: confirmAlert: always returns false (no dialog); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): https

### `create-remix` — Create Remix
- dir: `raycast-create-remix` · commands: 1 · modes: view
- Degraded: openCommandPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, https, child_process
...
- Degraded: confirmAlert: always returns false (no dialog); openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): https
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, https, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, dns
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): http, https
...
- Degraded: captureException: no-op; confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; openCommandPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; openExtensionPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs

### `migros` — Migros
- dir: `migros` · commands: 1 · modes: view
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): https, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs, v8
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: openCommandPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: confirmAlert: always returns false (no dialog); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: openExtensionPreferences: no-op; uses Node built-ins (ok in trusted mode): https, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): dns, net, tls
...
- Degraded: openExtensionPreferences: no-op; Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): http, https, fs
...
- Degraded: openExtensionPreferences: no-op; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- Degraded: confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): child_process, net, fs
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs, https
...
- Degraded: confirmAlert: always returns false (no dialog); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: confirmAlert: always returns false (no dialog); openCommandPreferences: no-op; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; Cache: Cache.get returns defaults; Cache.set/remove throw; uses Node built-ins (ok in trusted mode): fs, https
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); Cache: Cache.get returns defaults; Cache.set/remove throw; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; confirmAlert: always returns false (no dialog); uses Node built-ins (ok in trusted mode): fs
...
- Degraded: Cache: Cache.get returns defaults; Cache.set/remove throw; useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; confirmAlert: always returns false (no dialog); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: confirmAlert: always returns false (no dialog); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, https
...
- Degraded: openExtensionPreferences: no-op; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): dgram
...
- Degraded: openExtensionPreferences: no-op; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, https, child_process
