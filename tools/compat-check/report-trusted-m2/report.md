...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs, child_process, http
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; unsupported command mode(s): menu-bar: mode "menu-bar", brew-maintenance: mode "menu-bar"
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; unsupported command mode(s): menu-bar: mode "menu-bar"; declares AI tools[] (8) — AI extensions not supported
...
- **Blockers:** getApplications: throws — application discovery not wired; showInFinder: throws — showInFinder not wired; getSelectedText: throws — selection APIs not wired; unsupported command mode(s): menu-bar: mode "menu-bar"; declares AI tools[] (12) — AI extensions not supported
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): child_process, fs

### `at-profile` — @ Profile
- dir: `at-profile` · commands: 6 · modes: view|no-view
- **Blockers:** declares AI tools[] (2) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; getFrontmostApplication: throws — application discovery not wired
- Degraded: BrowserExtension: loads; throws if called (browser bridge not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process, http, https
...
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; BrowserExtension: loads; throws if called (browser bridge not wired); getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): http, fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; getFrontmostApplication: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; BrowserExtension: loads; throws if called (browser bridge not wired); getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): http, fs, child_process
- Needs review: @raycast/api:Navigation (not in Invoke surface — needs review)
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; getFrontmostApplication: throws — application discovery not wired; trash: throws — file trash not wired; unsupported command mode(s): menu-bar-monitor: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, child_process, readline
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** trash: throws — file trash not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** declares AI tools[] (3) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** trash: throws — file trash not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** declares AI tools[] (5) — AI extensions not supported
- Degraded: BrowserExtension: loads; throws if called (browser bridge not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process

### `firebase-import-export` — Manage Firebase Firestore Collections
- dir: `firebase-import-export` · commands: 2 · modes: no-view
- **Blockers:** showInFinder: throws — showInFinder not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:OAuthService (not implemented in Invoke); @raycast/utils:getAccessToken (not implemented in Invoke); @raycast/utils:withAccessToken (not implemented in Invoke)
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** trash: throws — file trash not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, readline

### `gemini-tts` — Gemini TTS
- dir: `gemini-tts` · commands: 9 · modes: no-view|view|menu-bar
- **Blockers:** getSelectedText: throws — selection APIs not wired; unsupported command mode(s): playback-status: mode "menu-bar"
...
- **Blockers:** declares AI tools[] (14) — AI extensions not supported
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)

### `getcompress` — GetCompress
- dir: `getcompress` · commands: 3 · modes: no-view|view
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); runPowerShellScript: Windows-only; throws on macOS (import loads); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs

### `ghostty` — Ghostty
- dir: `ghostty` · commands: 7 · modes: no-view|view
- **Blockers:** getFrontmostApplication: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getApplications: throws — application discovery not wired; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired; unsupported command mode(s): unread-notifications: mode "menu-bar", my-issues-menu: mode "menu-bar", my-stats-menu: mode "menu-bar", my-pull-requests-menu: mode "menu-bar"; declares AI tools[] (15) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; unsupported command mode(s): todomenubar: mode "menu-bar", mrmenu: mode "menu-bar", issuemenu: mode "menu-bar"; declares AI tools[] (12) — AI extensions not supported
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): https, fs
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; unsupported command mode(s): unreadmailsmenu: mode "menu-bar"
...
- **Blockers:** getApplications: throws — application discovery not wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, https, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process, https
...
- **Blockers:** unsupported command mode(s): menubar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; updateCommandMetadata: loads; no-op (command metadata updates not wired); launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** declares AI tools[] (2) — AI extensions not supported
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired; declares AI tools[] (11) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:OAuthService (not implemented in Invoke); @raycast/utils:withAccessToken (not implemented in Invoke)
...
- **Blockers:** showInFinder: throws — showInFinder not wired; declares AI tools[] (10) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; showInFinder: throws — showInFinder not wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getApplications: throws — application discovery not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** trash: throws — file trash not wired; unsupported command mode(s): check-deploy-status: mode "menu-bar"
...
- **Blockers:** getApplications: throws — application discovery not wired; unsupported command mode(s): unread-notifications: mode "menu-bar"; declares AI tools[] (22) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, dgram, http
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; getDefaultApplication: throws — application discovery not wired; showInFinder: throws — showInFinder not wired
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; unsupported command mode(s): menu-bar-notifications: mode "menu-bar"
...
- **Blockers:** declares AI tools[] (2) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process

### `media-converter` — Media Converter
- dir: `media-converter` · commands: 4 · modes: view
- **Blockers:** showInFinder: throws — showInFinder not wired; declares AI tools[] (2) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); launchCommand: loads; throws if called (inter-command launch not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, child_process, module
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** declares AI tools[] (1) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** trash: throws — file trash not wired; unsupported command mode(s): health-menu-bar: mode "menu-bar"
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; unsupported command mode(s): nuxt-dev-server: mode "menu-bar"; declares AI tools[] (8) — AI extensions not supported
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getSelectedText: throws — selection APIs not wired; showInFinder: throws — showInFinder not wired
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; AI: AI.ask throws — Invoke AI not yet wired
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); updateCommandMetadata: loads; no-op (command metadata updates not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; declares AI tools[] (3) — AI extensions not supported
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)

### `pieces-raycast` — Pieces for Raycast
- dir: `pieces-raycast` · commands: 9 · modes: no-view|view
- **Blockers:** getSelectedText: throws — selection APIs not wired
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); BrowserExtension: loads; throws if called (browser bridge not wired); getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/api:Preferences (not in Invoke surface — needs review)
...
- **Blockers:** getApplications: throws — application discovery not wired; getSelectedText: throws — selection APIs not wired; getFrontmostApplication: throws — application discovery not wired; AI: AI.ask throws — Invoke AI not yet wired; unsupported command mode(s): index: mode "menu-bar"
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, vm, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process

### `portfolio-tracker` — Portfolio Tracker
- dir: `portfolio-tracker` · commands: 3 · modes: view
- **Blockers:** declares AI tools[] (6) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; updateCommandMetadata: loads; no-op (command metadata updates not wired); declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** showInFinder: throws — showInFinder not wired; AI: AI.ask throws — Invoke AI not yet wired; getSelectedText: throws — selection APIs not wired; unsupported command mode(s): menubar-item: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
- Needs review: @raycast/utils:useAI (not implemented in Invoke)
...
- **Blockers:** showInFinder: throws — showInFinder not wired; getFrontmostApplication: throws — application discovery not wired; unsupported command mode(s): search-pins-menu-bar: mode "menu-bar"
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getDefaultApplication: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; declares AI tools[] (2) — AI extensions not supported
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); getSelectedFinderItems: loads; throws if called (Finder selection not wired); BrowserExtension: loads; throws if called (browser bridge not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getApplications: throws — application discovery not wired; showInFinder: throws — showInFinder not wired
- Degraded: BrowserExtension: loads; throws if called (browser bridge not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): net, tls, fs, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process, https
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; updateCommandMetadata: loads; no-op (command metadata updates not wired); launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): http
- Needs review: @raycast/utils:OAuthService (not implemented in Invoke)
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; trash: throws — file trash not wired; showInFinder: throws — showInFinder not wired
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; unsupported command mode(s): menubar-stickies: mode "menu-bar"
- Degraded: updateCommandMetadata: loads; no-op (command metadata updates not wired); launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; unsupported command mode(s): menu-bar: mode "menu-bar"
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired; unsupported command mode(s): show-today-in-menu-bar: mode "menu-bar"; declares AI tools[] (12) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
- Needs review: @raycast/api:Tool (not in Invoke surface — needs review)
...
- **Blockers:** AI: AI.ask throws — Invoke AI not yet wired
- Degraded: updateCommandMetadata: loads; no-op (command metadata updates not wired); launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, http, child_process
...
- **Blockers:** showInFinder: throws — showInFinder not wired; getApplications: throws — application discovery not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getApplications: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; getApplications: throws — application discovery not wired; unsupported command mode(s): menu-bar: mode "menu-bar"; declares AI tools[] (29) — AI extensions not supported
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; declares background `interval` command(s) — not scheduled; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/utils:OAuthService (not implemented in Invoke); @raycast/utils:withAccessToken (not implemented in Invoke)
...
- **Blockers:** unsupported command mode(s): menuBar: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
- Needs review: @raycast/utils:CachedPromiseOptions (not implemented in Invoke)
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, net
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; BrowserExtension: loads; throws if called (browser bridge not wired); uses Node built-ins (ok in trusted mode): fs
- Needs review: @raycast/api:KeyEquivalent (not in Invoke surface — needs review)
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): http
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired; unsupported command mode(s): live: mode "menu-bar"
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process
...
- **Blockers:** OAuth: OAuth.PKCEClient throws — OAuth not yet wired
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): http, fs
...
- **Blockers:** getSelectedText: throws — selection APIs not wired; declares AI tools[] (2) — AI extensions not supported
- Degraded: BrowserExtension: loads; throws if called (browser bridge not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getSelectedText: throws — selection APIs not wired; getApplications: throws — application discovery not wired
- Degraded: BrowserExtension: loads; throws if called (browser bridge not wired); getSelectedFinderItems: loads; throws if called (Finder selection not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, fs
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; getApplications: throws — application discovery not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); runPowerShellScript: Windows-only; throws on macOS (import loads); uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): net
...
- **Blockers:** getApplications: throws — application discovery not wired; unsupported command mode(s): show-recent-projects-in-menu-bar.command: mode "menu-bar", show-recent-builds-in-menu-bar.command: mode "menu-bar"; declares AI tools[] (14) — AI extensions not supported
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); launchCommand: loads; throws if called (inter-command launch not wired); declares extension-level `ai` instructions — ignored; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- **Blockers:** getFrontmostApplication: throws — application discovery not wired; showInFinder: throws — showInFinder not wired
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs
...
- **Blockers:** getApplications: throws — application discovery not wired; declares AI tools[] (3) — AI extensions not supported
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares extension-level `ai` instructions — ignored; uses Node built-ins (ok in trusted mode): fs, https, http, child_process
...
- Degraded: updateCommandMetadata: loads; no-op (command metadata updates not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, https
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); launchCommand: loads; throws if called (inter-command launch not wired); uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; useExec: only runs in trusted (unsandboxed) extensions; throws in sandbox; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): https, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, https, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; BrowserExtension: loads; throws if called (browser bridge not wired); launchCommand: loads; throws if called (inter-command launch not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; updateCommandMetadata: loads; no-op (command metadata updates not wired); declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): tls, https, net, fs, http2, dns
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; runPowerShellScript: Windows-only; throws on macOS (import loads); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): child_process, dns
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): http, https
...
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); updateCommandMetadata: loads; no-op (command metadata updates not wired); uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): https, fs
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, http, https
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares background `interval` command(s) — not scheduled; uses Node built-ins (ok in trusted mode): child_process, fs, v8
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs, https
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; runPowerShellScript: Windows-only; throws on macOS (import loads); uses Node built-ins (ok in trusted mode): child_process, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): http, https, fs
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): http, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; getSelectedFinderItems: loads; throws if called (Finder selection not wired); uses Node built-ins (ok in trusted mode): fs, child_process, https
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs, child_process
...
- Degraded: BrowserExtension: loads; throws if called (browser bridge not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; launchCommand: loads; throws if called (inter-command launch not wired); updateCommandMetadata: loads; no-op (command metadata updates not wired); uses Node built-ins (ok in trusted mode): child_process
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): https
...
- Degraded: getSelectedFinderItems: loads; throws if called (Finder selection not wired); declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): net, fs
...
- Degraded: useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; updateCommandMetadata: loads; no-op (command metadata updates not wired); uses Node built-ins (ok in trusted mode): fs
...
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; uses Node built-ins (ok in trusted mode): https
...
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired); useNavigation: useNavigation().push/pop are no-ops; use declarative Action.Push; declares command `arguments[]` — not passed by runtime yet; uses Node built-ins (ok in trusted mode): fs
