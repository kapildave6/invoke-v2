...
- **Blockers:** denied Node built-ins in sandbox: fs, module, child_process, http, https
...
- **Blockers:** denied Node built-ins in sandbox: fs, dgram, http
...
- **Blockers:** denied Node built-ins in sandbox: fs, vm, child_process
- Degraded: launchCommand: loads; throws if called (inter-command launch not wired)
...
- **Blockers:** denied Node built-ins in sandbox: fs, net
...
- **Blockers:** denied Node built-ins in sandbox: fs, https, http, child_process
