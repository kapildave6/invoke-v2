...
| Window management (maximize/halves/quarters/center/thirds + cycling + custom) | ✅ | AX move/resize; maximize, halves, quarters, center, **First/Center/Last Third + First/Last Two-Thirds**, **½→⅔→⅓ cycling** (WM-1), and **user-defined Custom Window Management Commands via a Raycast-style position editor** (9-anchor Position + Size Auto/pt + Offset pt + live screen preview; Create/Edit/Delete, bindable — Chunk WM-3 + builder-parity 2026-06-23), plus **multi-app Window Layout Commands** ("+ Add" apps, each placed with the same editor; positions several windows at once — builder-parity 2026-06-24). Root commands + per-command hotkeys (needs Accessibility). Full WM parity: **WM-1 cycling/thirds + WM-2 extension API + WM-3 Create Window Command + WM-4 Create Window Layout (Raycast 9-anchor editor) DONE; only WM-5 Stage Manager/presets remains** |
